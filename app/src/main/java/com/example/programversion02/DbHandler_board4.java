...
public class DbHandler_board4 extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "board_spinner4";
    private static final String TABLE_NAME = "labels";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_NAME = "name1";

    public DbHandler_board4(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('신규')";
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('기능추가')";
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('기능개선')";
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('기능삭제')";
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('오류수정')";
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('사용불가')";
        db.execSQL(CREATE_ITEM_TABLE);

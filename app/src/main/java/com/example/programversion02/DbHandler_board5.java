...
public class DbHandler_board5 extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "board_spinner5";
    private static final String TABLE_NAME = "labels";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_NAME = "name1";

    public DbHandler_board5(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_ITEM_TABLE);
        CREATE_ITEM_TABLE = "INSERT INTO labels(name1) VALUES('양산')";
        db.execSQL(CREATE_ITEM_TABLE);
